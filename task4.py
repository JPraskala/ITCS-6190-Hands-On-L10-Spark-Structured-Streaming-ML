...
if not os.path.exists(MODEL_PATH):
    ...
    train_data_with_features = assembler.transform(train_df) # Keep the label column for training
...
stream_with_features = assembler_inference.transform(parsed_stream).select("trip_id", "driver_id", "distance_km", "fare_amount", "features") # Preserve driver_id for output
